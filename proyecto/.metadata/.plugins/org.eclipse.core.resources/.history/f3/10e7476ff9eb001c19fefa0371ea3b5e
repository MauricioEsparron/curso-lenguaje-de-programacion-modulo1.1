...
public class FrmRegistroMovimiento extends JInternalFrame implements ActionListener, KeyListener, MouseListener {
	...
	private void registrar() {
		...
		if (cod_movimiento == -1 || num_Tarjeta == -1 || cod_cliente == 0 || num_cuenta == -1 || operacion == 0
